...
ENTRIES = [
    ...
    # === LOTE 7 (24/05/2026 02:44 -> 23/05/2026 22:36) ===
    ('Helder Hamada', 'helder.hamada@yahoo.com', 5, 'final', '24/05/2026 02:44', 'Aprofundar meus conhecimentos e ajudar as é-a terem saúde'),
    ('Everton Capitanio', 'evertoncapitanio@yahoo.com.br', 5, 'vamos', '24/05/2026 02:44', 'Ótima trilha para direcionar nosso pensamento e reflexão.'),
    ('Helder Hamada', 'helder.hamada@yahoo.com', 5, 'glicemico', '24/05/2026 02:42', 'Estou mais confiante e com mais informações adequadas'),
    ('Arivane Batista do Nascimento', 'Arivanebatista@gmail.com', 5, 'pressao', '24/05/2026 02:41', 'Anamnese é fundamental'),
    ('Alysson Eugênio de Souza', 'alysson.aes@gmail.com', 4, 'vamos', '24/05/2026 02:40', 'T'),
    ('Helder Hamada', 'helder.hamada@yahoo.com', 4, 'pressao', '24/05/2026 02:39', 'Estou adquirindo conhecimento para que consiga ter mais confiança'),
    ('Helder Hamada', 'helder.hamada@yahoo.com', 5, 'aplica', '24/05/2026 02:35', 'Ainda não trabalho com o público apresentado'),
    ('Helder Hamada', 'helder.hamada@yahoo.com', 5, 'vamos', '24/05/2026 02:31', 'Muito bom!'),
    ('Marliza Canal Peres', 'canalmarliza@gmail.com', 2, 'pressao', '24/05/2026 02:30', 'Me sinto pouco preparada; começando a entender melhor todo mecanismo do coração.'),
    ('Arivane Batista do Nascimento', 'Arivanebatista@gmail.com', 5, 'aplica', '24/05/2026 02:30', 'Idosos'),
    ('Luciene Cristina Bartolo', 'lucienecb1975@gmail.com', 5, 'final', '24/05/2026 02:27', 'Me tornar referência'),
    ('Edvane de Sousa Lima', 'edsousalima@gmail.com', 5, 'final', '24/05/2026 02:24', 'Ser um profissional bem qualificado!'),
    ('Thiago Henrique da Silva', 'Thiagoh.dasilva@hotmail.com', 5, 'final', '24/05/2026 02:21', 'Transmitir confiança e segurança para os alunos e para a rede profissionais que fazem essa indicação.'),
    ('Luciene Cristina Bartolo', 'lucienecb1975@gmail.com', 5, 'glicemico', '24/05/2026 02:20', 'Puxa não imaginava a complexidade'),
    ('Robisom Pedro da Silva', 'Robisombj@gmail.com', 5, 'final', '24/05/2026 02:17', 'Meu principal objetivo é integrar a avaliação clínica e o movimento humano para prescrever exercícios altamente seguros e eficientes no tratamento e controle de doenças crônicas'),
    ('Josiane Peixoto dos Santos Simões', 'jo.peixoto.js@gmail.com', 5, 'final', '24/05/2026 02:15', 'Fazer a diferença na vida desses grupos especiais'),
    ('Flávia Barbosa Cerávolo', 'fbceravolo@gmail.com', 5, 'pressao', '24/05/2026 02:11', 'É possível compreender muito melhor que tipos de estímulos podemos utilizar durante as aulas e o que eles acarretarão ao aluno. Durante a leitura, pensei em vários alunos meus e identifiquei situações que me contam de seus cotidianos que tbm poderei orientá-los com mais clareza.'),
    ('Ricardo', 'Ricardopersonal12@gmail.com', 5, 'final', '24/05/2026 02:08', 'Melhorar capacitação profissional.'),
    ('Thiago Henrique da Silva', 'Thiagoh.dasilva@hotmail.com', 4, 'glicemico', '24/05/2026 02:08', 'Ansiosos pelo workshop!'),
    ('Edvane de Sousa Lima', 'edsousalima@gmail.com', 5, 'glicemico', '24/05/2026 02:07', 'Não!!'),
    ('Eloísa Pereira de Souza', 'pereiraeloisa321@gmail.com', 1, 'aplica', '24/05/2026 02:06', 'Diabéticos'),
    ('Robisom Pedro da Silva', 'Robisombj@gmail.com', 5, 'glicemico', '24/05/2026 02:05', 'Ansioso para adquirir mais conhecimento.'),
    ('Rogério Soares Mendes', 'soaresmendes@hotmail.com', 5, 'final', '24/05/2026 02:03', 'Ajudar estas pessoas, melhorando sua qualidade de vida e sua saúde.'),
    ('Maico Artico', 'maicoartico@hotmail.com', 5, 'vamos', '24/05/2026 02:02', 'Simples e muito didático'),
    ('Sibeli Angra da Silva', 'angrasibeli@gmail.com', 5, 'pressao', '24/05/2026 02:01', 'Estou gostando'),
    ('Marliza Canal Peres', 'canalmarliza@gmail.com', 3, 'aplica', '24/05/2026 02:00', 'Cardiopatas.'),
    ('Ricardo', 'Ricardopersonal12@gmail.com', 3, 'glicemico', '24/05/2026 01:58', 'Acredito que sim'),
    ('Paula Rodrigues da Silva', 'paulinharsnat@gmail.com', 5, 'pressao', '24/05/2026 01:49', 'Bem'),
    ('Robisom Pedro da Silva', 'Robisombj@gmail.com', 5, 'pressao', '24/05/2026 01:49', 'Mais seguro'),
    ('Jeilso Feitosa da Silva', 'jasonkan25@gmail.com', 5, 'final', '24/05/2026 01:49', 'Promover a saúde e melhorar qualidade de vida.'),
    ('Kassiana Marina Da Silva Winck', 'Kassianawinck@gmail.com', 5, 'aplica', '24/05/2026 01:47', 'Hipertensos, idosos, cardiopatas.'),
    ('Sibeli Angra da Silva', 'angrasibeli@gmail.com', 5, 'aplica', '24/05/2026 01:46', 'Ótima'),
    ('Rogério Soares Mendes', 'soaresmendes@hotmail.com', 4, 'glicemico', '24/05/2026 01:45', 'Explicação de fácil aprendizado.'),
    ('Ricardo', 'Ricardopersonal12@gmail.com', 4, 'pressao', '24/05/2026 01:44', 'Estou no caminho certo.'),
    ('Sheila Rodrigues Andrade', 'shenog.malaquias@hotmail.com', 5, 'final', '24/05/2026 01:44', 'Quero me especializar no atendimento desse público, para fazer a diferença na qualidade de vida de cada aluno.'),
    ('Jeilso Feitosa da Silva', 'jasonkan25@gmail.com', 5, 'glicemico', '24/05/2026 01:34', 'Espero aprender mais'),
    ('Kassiana Marina Da Silva Winck', 'Kassianawinck@gmail.com', 5, 'vamos', '24/05/2026 01:33', 'Eu trabalho com populações especiais, a jornada de prescrição de exercícios físicos para grupos especiais, será uma aprimoramento.'),
    ('Marcio Claudio Gaefke', 'marciovidaativa@gmail.com', 5, 'pressao', '24/05/2026 01:31', 'Me sinto apto, e a jornada trará ainda mais segurança e conhecimento!'),
    ('Robisom Pedro da Silva', 'Robisombj@gmail.com', 5, 'aplica', '24/05/2026 01:31', 'Cardiopatias, diabéticos e oncológico'),
    ('Ricardo', 'Ricardopersonal12@gmail.com', 3, 'aplica', '24/05/2026 01:31', 'Cardíacos'),
    ('Flávia Barbosa Cerávolo', 'fbceravolo@gmail.com', 4, 'aplica', '24/05/2026 01:30', 'Trabalho com idosos'),
    ('Sheila Rodrigues Andrade', 'shenog.malaquias@hotmail.com', 5, 'glicemico', '24/05/2026 01:27', 'Ainda estou insegura, porém com visão melhor quanto a determinadas situações.'),
    ('Thiago Henrique da Silva', 'Thiagoh.dasilva@hotmail.com', 4, 'pressao', '24/05/2026 01:24', 'Com esse excelente conteúdo, ficou mais seguro e confiante prescrever exercícios!'),
    ('Denise Akemi Simões de Oliveira', 'de.sid@hotmail.com', 5, 'vamos', '24/05/2026 01:22', 'Estou gostando muito, material muito interessante. A didática muito legal. Adorei!!'),
    ('Marlete Chagas', 'marletechagas7@gmail.com', 5, 'glicemico', '24/05/2026 01:19', 'Muito interessante!'),
    ('Érika Andrade de Pedro', 'erikandradep1@gmail.com', 5, 'final', '24/05/2026 01:18', 'Promover qualidade de vida, bem estar e saúde.'),
    ('Robisom Pedro da Silva', 'Robisombj@gmail.com', 5, 'vamos', '24/05/2026 01:17', 'Sensacional!!'),
    ('Sibeli Angra da Silva', 'angrasibeli@gmail.com', 5, 'vamos', '24/05/2026 01:17', 'Vamos juntos aprofundar esse conhecimento'),
    ('Sheila Rodrigues Andrade', 'shenog.malaquias@hotmail.com', 5, 'pressao', '24/05/2026 01:16', 'Mais tranquila.'),
    ('Gabriel Bedini de Jesus', 'gabriel.bedini.jesus@gmail.com', 5, 'final', '24/05/2026 01:16', 'Conseguir educar e ajudar as pessoas nas áreas em que atuo.'),
    ('Alysson Cauã dos Santos', 'alisoncauan19@gmail.com', 5, 'final', '24/05/2026 01:15', 'Me tornar ótimo'),
    ('Jeilso Feitosa da Silva', 'jasonkan25@gmail.com', 5, 'pressao', '24/05/2026 01:14', 'Tenho que aprender muito ainda'),
    ('Gabriel Bedini de Jesus', 'gabriel.bedini.jesus@gmail.com', 3, 'glicemico', '24/05/2026 01:10', 'Como compor treinamentos associados aos exames clínicos?'),
    ('eng.benoni@gmail.com', 'Eng.benoni@gmail.com', 4, 'aplica', '24/05/2026 01:09', 'Diabetes e hipertenso'),
    ('Érika Andrade de Pedro', 'erikandradep1@gmail.com', 4, 'glicemico', '24/05/2026 01:07', 'Sim, o conhecimento é necessário'),
    ('Alysson Cauã dos Santos', 'alisoncauan19@gmail.com', 5, 'glicemico', '24/05/2026 01:07', 'Muito bom'),
    ('Marlete Chagas', 'marletechagas7@gmail.com', 5, 'pressao', '24/05/2026 01:07', 'Interessante.'),
    ('Josiane Peixoto dos Santos Simões', 'jo.peixoto.js@gmail.com', 5, 'glicemico', '24/05/2026 01:05', 'Preciso de mais conteúdos pra ficar mais segura'),
    ('Naiala Ferreira de Oliveira', 'nanaixavier@gmail.com', 4, 'aplica', '24/05/2026 01:04', 'Pessoas idosas.'),
    ('Juliana Silva Justino', 'juliana_justino@yahoo.com.br', 5, 'final', '24/05/2026 01:02', 'Ser uma profissional capaz de atender públicos diversificados com maior confiança .'),
    ('Claudemir Aparecido Rodrigues', 'claudemiraparecidorodrigues76@gmail.com', 5, 'final', '24/05/2026 01:00', 'Top'),
    ('Daniel Ravazzani', 'redtigertkdhap@yahoo.com.br', 5, 'final', '24/05/2026 01:00', 'Fazer a diferença na vida dos outros e lucrar com isso!'),
    ('Sheila Rodrigues Andrade', 'shenog.malaquias@hotmail.com', 5, 'aplica', '24/05/2026 00:57', 'Trabalho com alunos com lesões e idosos. Esse público me interessa.'),
    ('Daniel Ravazzani', 'redtigertkdhap@yahoo.com.br', 3, 'glicemico', '24/05/2026 00:52', 'Preciso aprender mais e estudar mais sobre o assunto, é muita responsabilidade'),
    ('Marlete Chagas', 'marletechagas7@gmail.com', 5, 'aplica', '24/05/2026 00:50', 'Relembrando muitas coisas, é muito bom.'),
    ('Flávia Barbosa Cerávolo', 'fbceravolo@gmail.com', 5, 'vamos', '24/05/2026 00:48', 'Achei muito importante os conceitos apresentados nesta primeira fase. Sem dúvidas um profissional que busque se capacitar cada vez mais, terá sucesso e reconhecimento ao atender melhor este público que necessita de atenção especial.'),
    ('Arivane Batista do Nascimento', 'Arivanebatista@gmail.com', 5, 'vamos', '24/05/2026 00:47', 'Conhecimento de qualidade'),
    ('Marcos Henrique do Nascimento Chagas', 'marcos.unioeste@gmail.com', 5, 'final', '24/05/2026 00:46', 'Tudo muito bom'),
    ('Paula Rodrigues da Silva', 'paulinharsnat@gmail.com', 5, 'aplica', '24/05/2026 00:43', 'Idosos cardiopatas.'),
    ('Luciene Cristina Bartolo', 'lucienecb1975@gmail.com', 5, 'pressao', '24/05/2026 00:41', 'Um pouco mais confiante do que qdo iniciei'),
    ('Thiago Henrique da Silva', 'Thiagoh.dasilva@hotmail.com', 3, 'aplica', '24/05/2026 00:41', 'Gestantes'),
    ('Marcos Henrique do Nascimento Chagas', 'marcos.unioeste@gmail.com', 5, 'glicemico', '24/05/2026 00:40', 'Tudo muito bom'),
    ('Junior Lira', 'delirasilva@gmail.com', 5, 'vamos', '24/05/2026 00:39', 'Conteúdo bacana, acredito que vem muita coisa boa por aí!'),
    ('Alessandra Cardoso', 'alessandra.araujo24@gmail.com', 5, 'final', '24/05/2026 00:39', 'Ajuda a levar saúde para as pessoas.'),
    ('Eda Maria Wiggert Ferreira Zaniolo', 'emwzaniolo@gmail.com', 5, 'final', '24/05/2026 00:37', 'Oferecer um atendimento de excelência.'),
    ('Jeilso Feitosa da Silva', 'jasonkan25@gmail.com', 5, 'aplica', '24/05/2026 00:35', 'Ainda sou só estudante'),
    ('Samira Garcia de Oliveira', 'samira_go@hotmail.com', 5, 'final', '24/05/2026 00:32', 'Meu maior objetivo como profissional de educação física é melhorar e manter a saúde e autonomia das pessoas.'),
    ('Marliza Canal Peres', 'canalmarliza@gmail.com', 5, 'vamos', '24/05/2026 00:32', 'Gostando muito.'),
    ('Alessandra Cardoso', 'alessandra.araujo24@gmail.com', 5, 'glicemico', '24/05/2026 00:31', 'Mais ou menos. Tenho a noção do sistema glicêmico mas espero aprender melhor a prescrever um treino para diabético'),
    ('Alysson Cauã dos Santos', 'alisoncauan19@gmail.com', 5, 'pressao', '24/05/2026 00:29', 'Me sinto mais seguro agora com esses conhecimentos'),
    ('Marlete Chagas', 'marletechagas7@gmail.com', 5, 'vamos', '24/05/2026 00:29', 'Bem elaborado, me faz querer saber mais.'),
    ('Gabriel Bedini de Jesus', 'gabriel.bedini.jesus@gmail.com', 3, 'pressao', '24/05/2026 00:26', 'Ainda algumas dúvidas em relação a colocação prática dessas funções fisiológicas na prescrição do treinamento.'),
    ('Samira Garcia de Oliveira', 'samira_go@hotmail.com', 5, 'glicemico', '24/05/2026 00:25', 'Se for um aluno diabético controlado me sinto segura sim, mas se a doença estiver descompensada, não me sinto segura.'),
    ('Luciene Cristina Bartolo', 'lucienecb1975@gmail.com', 5, 'aplica', '24/05/2026 00:25', 'Trabalho com idosos e mulheres gestantes. Quero me aprofundar em cardiopatas, hipertensos'),
    ('Andreza Cristina Rodrigues Oliveira', 'tsigaga@gmail.com', 5, 'pressao', '24/05/2026 00:22', 'Bom'),
    ('Alexandre Olimpio da Silva', 'alexandre.olimpio@hotmail.com', 4, 'final', '24/05/2026 00:20', 'Entregar qualidade de vida através da atividade física'),
    ('Daniel Ravazzani', 'redtigertkdhap@yahoo.com.br', 4, 'pressao', '24/05/2026 00:19', 'Não tenho segurança ainda, preciso me aprofundar mais no assunto'),
    ('Marcos Henrique do Nascimento Chagas', 'marcos.unioeste@gmail.com', 5, 'pressao', '24/05/2026 00:11', 'Tudo muito bom'),
    ('Alexandre Olimpio da Silva', 'alexandre.olimpio@hotmail.com', 4, 'glicemico', '24/05/2026 00:11', 'Conhecimento e aperfeiçoamento é o caminho para evoluir'),
    ('eng.benoni@gmail.com', 'Eng.benoni@gmail.com', 5, 'vamos', '24/05/2026 00:10', 'Cada estudo é mais um conhecimento novo'),
    ('Elisangela Martins', 'kokito.kokoro@gmail.com', 5, 'final', '24/05/2026 00:10', 'Excelência'),
    ('Gabriel Bedini de Jesus', 'gabriel.bedini.jesus@gmail.com', 3, 'aplica', '24/05/2026 00:06', 'Hipertensos.'),
    ('Naiala Ferreira de Oliveira', 'nanaixavier@gmail.com', 4, 'vamos', '24/05/2026 00:03', 'Estou curiosa!'),
    ('Juliana balabenute faci', 'Jubafefa@yahoo.com.br', 5, 'vamos', '24/05/2026 00:03', 'Sim'),
    ('Samira Garcia de Oliveira', 'samira_go@hotmail.com', 5, 'pressao', '24/05/2026 00:02', 'Me sinto segura para prescrever, pois gosto muito desse assunto desde a graduação e procuro sempre estudar sobre para não esquecer.'),
    ('Hibia Heverlling Fernandes Lameiras', 'hibiafe@gmail.com', 5, 'vamos', '24/05/2026 00:00', 'Esta primeira fase foi muito importante para ampliar minha visão sobre a atuação do profissional de Educação Física, principalmente na prescrição de exercícios para grupos especiais. Percebi a importância de buscar conhecimento técnico e atualização constante para oferecer um atendimento seguro, individualizado e de qualidade, especialmente para idosos e pessoas com doenças crônicas.'),
    ('Patricia Buone', 'patidebuone@gmail.com', 5, 'final', '23/05/2026 23:57', 'Meu maior objetivo é trazer de volta a qualidade de vida da pessoa enferma, e já faço isso! Nao tem nada mais satisfatório que ver seu aluno conseguindo respirar sem um balão de oxigênio, ver ele voltar a andar sem o andador ou bengala, sua aluna te ligar dizendo que a osteoporose dela regrediu para uma osteopenia, e muito mais! Isso me faz sentir realizada profissionalmente! E querer estudar mais e mais, só para ver o brilho nos olhos deles de novo!'),
    ('Elisangela Martins', 'kokito.kokoro@gmail.com', 5, 'glicemico', '23/05/2026 23:56', 'Sim .'),
    ('Sheila Aparecida da Silva', 'shesilva.ss86@gmail.com', 5, 'glicemico', '23/05/2026 23:52', 'Sim'),
    ('Aldemar Moreira Pires', 'Dema_preto@hotmail.com', 5, 'final', '23/05/2026 23:52', 'Ser reconhecido pelo meu trabalho, esforço e experiência que aprendi ao longo de todos meus cursos e experiências'),
    ('Marcos Henrique do Nascimento Chagas', 'marcos.unioeste@gmail.com', 5, 'aplica', '23/05/2026 23:50', 'Tudo muito bom'),
    ('Amarildo Arca', 'professorarca1@gmail.com', 5, 'final', '23/05/2026 23:47', 'Ampliar o número de clientes e levar conhecimento e ajuda na melhora do bem estar, fazer com que as pessoas possam ter melhor qualidade de vida'),
    ('Érika Andrade de Pedro', 'erikandradep1@gmail.com', 4, 'pressao', '23/05/2026 23:46', 'Preciso de mais informações...'),
    ('Patricia Buone', 'patidebuone@gmail.com', 5, 'glicemico', '23/05/2026 23:43', 'por isso precisamos saber por horas esse aluno toma insulina na nossa anamnese de saúde!'),
    ('Leilane França Ferreira', 'fisioleilane@gmail.com', 5, 'vamos', '23/05/2026 23:42', 'Acredito que a jornada me deixará mais segura nos atendimentos'),
    ('Thiago Henrique da Silva', 'Thiagoh.dasilva@hotmail.com', 5, 'vamos', '23/05/2026 23:41', 'Conteúdo de fácil compreensão e de muito aprendizado. MUITO BOM!'),
    ('Alexandre Olimpio da Silva', 'alexandre.olimpio@hotmail.com', 5, 'pressao', '23/05/2026 23:40', 'Preciso me especializar melhor.'),
    ('Aldemar Moreira Pires', 'Dema_preto@hotmail.com', 5, 'glicemico', '23/05/2026 23:36', 'Quero muito aprender e ter muito conhecimento.'),
    ('Márcio Venâncio Duarte', 'marciovd85@gmail.com', 5, 'vamos', '23/05/2026 23:34', 'Ótimo material introdutório.'),
    ('Alysson Cauã dos Santos', 'alisoncauan19@gmail.com', 5, 'aplica', '23/05/2026 23:33', 'Eu ainda nao trabalho, mais presumo que vou em algum momento da vida trabalhar com pessoas da terceira idade entao é bom esse assunto estou aproveitando muito!'),
    ('Amarildo Arca', 'professorarca1@gmail.com', 5, 'glicemico', '23/05/2026 23:30', 'Sim, me sinto muito capaz de antes, entendo o por que do exército no diabete, como o GLUT4, funciona sem insulina e os riscos de hipo/ hiperglicemia. Mas autonomia vem com protocolo. Mas hoje eu saberia não fazer besteira e garantir a segurança do aluno com liberação médica, depois do Workshop quero ter segurança para otimizar resultados e tomar decisões melhores na hora, sem depender de tentativas e erros.'),
    ('Ana Paula Delamo', 'ana-delamopersonal@hotmail.com', 3, 'final', '23/05/2026 23:29', 'Provomer o bem estar físico com segurança as pessoas'),
    ('Ana Paula Delamo', 'ana-delamopersonal@hotmail.com', 3, 'glicemico', '23/05/2026 23:23', 'Ok'),
    ('Clébia Poliana Rodrigues Lopes', 'Klebia0078@gmail.com', 5, 'final', '23/05/2026 23:19', 'Promover saúde, qualidade de vida e transformação através do exercício físico.'),
    ('Alexandre Olimpio da Silva', 'alexandre.olimpio@hotmail.com', 4, 'aplica', '23/05/2026 23:18', 'Quero trabalhar com alunos hipertensos'),
    ('Caroline Iatauro', 'Caiatauro@bol.com.br', 5, 'final', '23/05/2026 23:16', 'Ter sucesso'),
    ('Aldemar Moreira Pires', 'Dema_preto@hotmail.com', 5, 'pressao', '23/05/2026 23:15', 'Prescrever com segurança nao e sobre se sentir confiante e sobre ter um processo a prova de erro confiança vem depois do processo'),
    ('Sheila Aparecida da Silva', 'shesilva.ss86@gmail.com', 4, 'pressao', '23/05/2026 23:13', 'Estou no caminho para melhorar cada vez o meu entendimento.'),
    ('Jonatan Shiniti Sooma', 'jonatansooma@gmail.com', 5, 'final', '23/05/2026 23:12', 'Bacana'),
    ('Patricia Buone', 'patidebuone@gmail.com', 3, 'pressao', '23/05/2026 23:12', 'Eu sempre tiro a pressao do aluno hipertenso antes de começar a aula para poder trabalhar com ele de forma segura!'),
    ('Érika Andrade de Pedro', 'erikandradep1@gmail.com', 2, 'aplica', '23/05/2026 23:11', 'Idosos e Neurodivergentes'),
    ('Jonatan Shiniti Sooma', 'jonatansooma@gmail.com', 5, 'glicemico', '23/05/2026 23:10', 'Boas as explicações'),
    ('Pérsio Rodrigues de Souza Costa', 'persiocostaribeirao655@gmail.com', 5, 'vamos', '23/05/2026 23:09', 'Conteúdo por enquanto que agrega conhecimento e aprendizagem.'),
    ('Caroline Iatauro', 'Caiatauro@bol.com.br', 2, 'glicemico', '23/05/2026 23:08', '👍'),
    ('Elisangela Martins', 'kokito.kokoro@gmail.com', 5, 'pressao', '23/05/2026 23:07', 'Preocupado'),
    ('Alexandre Olimpio da Silva', 'alexandre.olimpio@hotmail.com', 4, 'vamos', '23/05/2026 23:04', 'Estou com grande perspectiva de conhecimento neste evento'),
    ('Mario Rodrigo de Melo terra', 'Marioterra1978@gmail.com', 5, 'vamos', '23/05/2026 23:00', 'Atualização é indispensável para educação física.'),
    ('Ari Rossett Junior', 'personal.ari@gmail.com', 5, 'final', '23/05/2026 22:55', 'O meu objetivo profissional é devolver às pessoas a qualidade de vida perdida devido às necessidades especiais.'),
    ('Sidney Guilherme Alves', 'Sidneyguilherme37@gmail.com', 5, 'vamos', '23/05/2026 22:52', 'Boa.'),
    ('Marcelo', 'marcelodantaspbsb@gmail.com', 5, 'pressao', '23/05/2026 22:50', '✅✅✅'),
    ('Patricia Buone', 'patidebuone@gmail.com', 5, 'aplica', '23/05/2026 22:49', 'cardiacos, diabeticos, alzimer e parkinson'),
    ('Amarildo Arca', 'professorarca1@gmail.com', 5, 'pressao', '23/05/2026 22:47', 'Com os conteúdos e aplicativos, tudo facilita para uma ótima prescrição, essa é a grande importância de estudar e fazer cursos de aperfeiçoamento'),
    ('Josias Vieira Camargo', 'josias.camargo@hotmail.com', 5, 'pressao', '23/05/2026 22:45', 'Me sinto preparado mas posso aumentar meu conhecimento.'),
    ('Jonatan Shiniti Sooma', 'jonatansooma@gmail.com', 5, 'pressao', '23/05/2026 22:41', 'Bom módulo'),
    ('Caroline Iatauro', 'Caiatauro@bol.com.br', 5, 'pressao', '23/05/2026 22:39', 'Sim'),
    ('Clébia Poliana Rodrigues Lopes', 'Klebia0078@gmail.com', 5, 'glicemico', '23/05/2026 22:39', 'Sim, me sinto mais preparada para prescrever com autonomia para alunos diabéticos, mas também consciente da responsabilidade que isso exige. Busco sempre mais conhecimento para prescrever com segurança, respeitando individualidade, controle glicêmico, sinais de hipoglicemia, intensidade do treino e acompanhamento profissional. O exercício físico pode transformar muito a qualidade de vida desses alunos quando é bem orientado.'),
    ('Elisangela Martins', 'kokito.kokoro@gmail.com', 5, 'aplica', '23/05/2026 22:36', 'Idosos.'),
]
